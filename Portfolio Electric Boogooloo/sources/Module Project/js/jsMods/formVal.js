...
const formField = input ? input.parentElement : "";
...
const confirmPassword = confirmPasswordEl ? confirmPasswordEl.value.trim(): "".trim;
const password = passwordEl.value.trim();
...
export default function formValidation(action, event) {
